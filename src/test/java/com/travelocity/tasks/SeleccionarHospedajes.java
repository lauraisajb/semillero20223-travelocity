...
public class SeleccionarHospedajes implements Task {
    ...
    public SeleccionarHospedajes(String destinoHospedaje, Integer diasHospedaje){
    ...
    public static Performable destinoYDiasReservaHospedaje (String destinoHospedaje, Integer diasHospedaje){
        return instrumented(SeleccionarHospedajes.class, destinoHospedaje, diasHospedaje);
    }
